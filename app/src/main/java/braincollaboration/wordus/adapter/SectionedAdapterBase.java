 ...
 */
public abstract class SectionedAdapterBase<T extends Categorizable> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (this.getItemViewType(position)) {
            ...
            default: {
                throw new RuntimeException("SectionedAdapterBase could not bind the requested view type.");
            }
        }
    }
    ...
    public int getItemViewType(int position) {
        if (itemList.get(position) instanceof Categorizable) {
            ...
            throw new RuntimeException("SectionedAdapterBase was unable to determine the view type for the item at position " + position);
        }
    }
